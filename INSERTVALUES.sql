...
DELETE FROM dbo.FADU_MEDPERS;
DELETE FROM dbo.FADU_MEDALHAS;
DELETE FROM dbo.FADU_PERSONMOD;
DELETE FROM dbo.FADU_PERSONEQUIPA;
DELETE FROM dbo.FADU_ATLETA;
DELETE FROM dbo.FADU_ARBITRO;
DELETE FROM dbo.FADU_TREINADOR;
DELETE FROM dbo.FADU_UNIVERSIDADE;
DELETE FROM dbo.FADU_JOGO;
DELETE FROM dbo.FADU_EQUIPA;
DELETE FROM dbo.FADU_PERSON;
DELETE FROM dbo.FADU_ASSMODALIDADE;
DELETE FROM dbo.FADU_ASSOCIAÇAO_ACADEMICA;
DELETE FROM dbo.FADU_ORGANIZACAO;
DELETE FROM dbo.FADU_MODALIDADE;
DELETE FROM dbo.FADU_FASE;
DELETE FROM dbo.FADU_TIPOMEDALHA;
-- ========================
